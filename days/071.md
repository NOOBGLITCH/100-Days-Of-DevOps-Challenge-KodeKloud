...
<img width="2948" height="1596" alt="image" src="https://github.com/user-attachments/assets/5791057d-d20e-4ab3-ac86-af7902becb1b" />


4. Go to Manage Jenkins > System  and Add SSH sites under SSH remote Posts
<img width="2794" height="1598" alt="image" src="https://github.com/user-attachments/assets/fbaf8e3e-07e8-4cab-ba76-5d6879ebc2fa" />

5. Create a freestyle job `install-packages` with following configs

    - Add Parameter "PACKAGE"
  <img width="2978" height="1514" alt="image" src="https://github.com/user-attachments/assets/4238966a-4e27-40bc-bbbe-60257096417b" />

    - Build Steps
    Choose `Execute shell script on remote host using ssh`
   <img width="2842" height="1586" alt="image" src="https://github.com/user-attachments/assets/fb2294df-7594-495b-b65d-6ce336f10bb7" />

    - Apply and Save

6. To execute: Dashboard > install-packages > Build with Parameters

 <img width="2988" height="1334" alt="image" src="https://github.com/user-attachments/assets/6e63070f-9569-41ab-bc00-4c98b409c4dc" />

    - Execute
   <img width="3002" height="1258" alt="image" src="https://github.com/user-attachments/assets/c50163cf-db08-4056-95d9-cf09afe23447" />
