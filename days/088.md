...
-   Using the playbook, install `httpd` web server on all app servers. Additionally, make sure its service should be up and running.
...
2.  Add contents to `playbook.yml`:
